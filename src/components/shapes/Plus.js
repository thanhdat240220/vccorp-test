...
export default function PlusIcon({
    ...
    return (
        type === 1 ? (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 105 89" fill={fill} className="md:size-28 sm:size-12">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 115 131" fill={fill} className="md:size-32 sm:size-12">
